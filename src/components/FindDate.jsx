  ...
  return (
    <div>
        ...
        <div className="m-8 flex flex-row justify-center">
          <div className="  flex flex-col  justify-center items-center ">
            <div className="m-auto  sm:flex w-full  ">
              ...
              <div>
                <h1 className="text-lg font-semibold sm:mt-0 mt-4">
                  When you end your trip{" "}
                </h1>
                <DatePicker
                  selected={endDate}
      ...
      <div className=" w-screen h-20 items-center text-white shadow-3xl border-2 text-center fixed bottom-0">
        <button
          className="items-center bg-green-600 w-383 m-3 h-12 rounded-sm text-2xl font-semibold"
          onClick={changeDate}
        >
          Find
        </button>
