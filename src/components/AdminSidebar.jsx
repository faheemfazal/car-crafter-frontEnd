                 ...
                 className="group flex items-center gap-3.5 font-medium p-2 bg-white hover:text-white hover:bg-green-600 rounded-md">
                  ...
                  group-hover:left-14  group-hover:duration-300  group-hover:w-fit`}>
                    {menu?.name}
                        ...
                        <div  
                 className="group flex items-center gap-3.5 font-medium p-2 bg-white hover:text-white hover:bg-green-600 rounded-md" onClick={logout}>
                  <div><HiOutlineLogout /></div>
                
                  <h2 
           
                  className={`whitespace-pre duretion-500 
                  ${isMobile&&"opacity-0 translate-x-28 overflow-hidden"} transition-all transform  duration-500 delay-500`}>Logout
                  </h2>
                  <h2 
                  className={` ${!isMobile && 'hidden'} absolute left-48 bg-white font-semibold whitespace-pre
                  text-gray-900 rounded-md drop-shadow-lg px-0 py-0 w-0 overflow-hidden z-10  group-hover:px-2 group-hover:py-1
