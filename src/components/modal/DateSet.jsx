...
function DateSet({open,setOpen,selectedDate,setSelectedDate,endDate,setEndDate}) {
  ...
  useEffect(()=>{
    ...
    const handleStartDateChange = (date) => {
      console.log(date,'//////////,,');
        ...
        setEndDate(moment(date).set({hours: 0, minutes: 0, seconds: 0, milliseconds: 0}).toDate())
    ...
    const handleEndDateChange= (date)=>{
      ...
      if (hasTime) {
        console.log(date,'llllllllllllll..');
        setEndDate(date)
        dispatch(setLogin({
          ...state,
          date:selectedDate,
        ...
        <div className="  flex flex-col  justify-center items-center "  >
               <div className='m-auto   w-full sm:flex  '>
                ...
                <DatePicker
                  ...
                  minDate={selectedDate} maxDate={maxDate}
