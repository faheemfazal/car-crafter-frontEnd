        ...
        <div className="flex w-full ">
          <div className="rounded-2xl border-2 text-gray-700 border-gray-300 w-full h-full bg-white m-5 ">
            ...
            <div className="w-full h-14 bg-black flex">
              ...
              >
                <h1 className="lg:text-xl text-lg text-center text-white m-4">
              ...
              >
                <h1
                  className="lg:text-xl text-lg text-center text-white m-4 cursor-pointer"
                  onClick={() => {
                    setLive(false);
                    setCars(false);
                    setComplete(true);
                  ...
                  <div className="h-4/5 w-2/4">
                    <div className="w-full h-10 ">
                      ...
                      <div className=" m-4 font- ">
                        ...
                        <h1 className="font-bold">City :<span className="font-semibold">{data.city.toLowerCase()} </span></h1>
                        <h1 className="font-bold">Location :<span className="font-semibold">{data.neighbourhood.toLowerCase()}</span> </h1>
                        <h1 className="font-bold">
                          From : <span className="font-semibold">{data.city.toLowerCase()}</span>
                        </h1>
                        <h1 className="font-bold">
                          Car : <span className="font-semibold">{data.brand.toLowerCase()}</span>
                        </h1>
                      </div>
                    </div>
                    <div></div>
                  ...
                  <div className="w-full h-full border-2 ">
                    ...
                    <div className="w-full h-full flex">
                      <div className="w-7/12">
                        <div className=" m-4 font- ">
                          ...
                          <h1 className="font-bold">City :<span className="font-semibold">{data.hosterDetails.city.toLowerCase()}</span> </h1>
                          <h1 className="font-bold">Location :<span className="font-semibold">{data.hosterDetails.neighbourhood}</span> </h1>
                          <h1 className="font-bold" >
                            From : <span className="font-semibold">{data.hosterDetails.city.toLowerCase()}</span>
                          </h1>
                          <h1 className="font-bold">
                            Car : <span className="font-semibold">{data.hosterDetails.brand.toLowerCase()}</span>
                          </h1>
                        </div>
                    ...
                    "
                      ...
                      <div className="w-5/12 h-48 border-2 ">
                        ...
                        <div className="m-5">
                          <button
                            className="w-full h-14 bg-green-600 rounded-md text-white font-bold "
