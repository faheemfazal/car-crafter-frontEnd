...
function RendUserHomeScreen() {
  ...
  const { time, date, location, endDate } = useSelector(
  ...
  return (
    <div className="bg-gray-200">
      ...
      {open && (
        <div className="md:visible invisible  md:static absolute w-28 h-12 bg-green-600 mt-5 flex justify-between">
          <h1 className="text-gray-200 text-2xl m-1">Filter</h1>
          <BiChevronsLeft
            className="text-white text-4xl m-1 "
          ...
          <div className="invisible md:static absolute  md:visible md: h-[700px] w-500  bg-white mt-5 ">
            ...
            <div className="mt-3">
              ...
              <div className=" border-gray-300 w-full mt-3 ml-2  rounded-lg h-28 flex flex-wrap gap-y-0  ">
                <div
                  className="w-2/5 h-3/5 border-2 flex flex-col justify-center items-center z-40 cursor-pointer"
                  onClick={() => filterHighToLow("LowtoHigh")}
                >
                  <h1>Low to High</h1>
                </div>
                <div
                  className="w-2/5 h-3/5 border-2 ml-4 flex flex-col justify-center items-center z-40 cursor-pointer"
        ...
        <div className="w-full flex flex-col h-screen scrollbar-hide overflow-scroll ">
          <div className="w-full h-28 flex  mt-2 justify-center md:static absolute">
            <div className="w-5/12 h-24 m-2 ml-5  md:static absolute invisible md:visible">
              <div
                className="rounded-xl border-2 border-green-600 h-16 flex pt-1"
                onClick={() =>
                  navigate("/findPlace", {
                ...
                <div className="h-52 ">
                  ...
                  <div className="flex ml-2 mt-2">
                    <p className=" text-gray-500">
                      {data?.transmission} . {data.fual} . 5Seat{" "}
                    </p>
                  </div>
                  <hr className="mt-3" />
