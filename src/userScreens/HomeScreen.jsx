         ...
         <div className="bg-white w-full  ">
            <div className=" bg-white h-screen    border-black  ">
                <div className="w-full h-44 p-4 ">
                    <h1 className="text-center sm:text-4xl text-2xl font-bold  ">WE LOVE GIVING BEST EXPERIENCES</h1>
                    <h1 className="text-center p-2 text-xl mt-2 font-semibold">We cover you under all the circumstances to ensure the best journey</h1>
            ...
            <h1 className="sm:text-3xl text-2xl p-2 text-center text-white font-semibold filter " >The perfect car for your next trip is just around the corner</h1>
         </div>
                </div>
