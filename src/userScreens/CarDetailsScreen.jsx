...
function CarDetailsScreen() {
    ...
    const getCheckout = ()=>{
        if(token){
            navigate(`/checkout/${carData}`,{state:{amount:amount + Package + 99,Package}})
    ...
    console.log(car,'kkkkkkkkkkkkkkfffffff');
  ...
  return (
    <div className='w-'>
        ...
        <div className='bg-slate-100 lg:flex  justify-center'>
           ...
           <AiOutlineArrowLeft className="ml-5 mt-5 text-xl" onClick={()=>{navigate('/home')}} />
           ...
           <div className='flex justify-between '>
            ...
            <div className='w-full h-4/12  sm:ml-10 ml-0  overflow  '>
               <div className='w-full sm:h-80 h-60  bg-white rounded-xl  border-2 border-gray-300 items-center flex justify-center justify-around'>
                     <div className='sm:w-16 sm:h-16 w-10 h-10 rounded-full bg-slate-900' onClick={goToPrevious}>
                     <BsArrowLeft className='text-white sm:text-3xl text-xl font-semibold sm:m-4 m-2.5' />
                     </div>
                      <img src={carImg && carImg[currentIndex]?.url} alt="" className='sm:h-72 h-52' />
                     
                 {/* {  carImg.map((data,index)=> ( */}
                     <div className='sm:w-16 sm:h-16 w-10 h-10 rounded-full bg-slate-900' >
                     <BsArrowLeft  className='text-white sm:text-3xl text-xl font-semibold sm:m-4 m-2.5 -scale-x-90' onClick={goToNext}/>
               ...
               <div className='w-full h- bg-white rounded-xl  border-2 border-gray-300 mt-12  '>
                ...
                <div className='flex justify-between w-full'>
                    <div className='p-2'>
                        <h1 className='ml-3 mr-3 text-2xl'>{car.brand}  {car.year}</h1>
                        <p className='text-gray-500 ml-3'>{car.fual} . {car.carNumber} . {car.transmission}</p>
                    </div>
                    <div className='flex w-64'>
                        ...
                        <div className='p-3 mr-3'>
                           <h1 className='text-lg'>{car.owner?.name} is a CarCrafter</h1>
                ...
                <div className='m-5 '>
                    ...
                    <div className='rounded-xl  border-2 border-gray-300 mt-12 h-32 flex justify-between'>
                        <div className='p-5'>
                        <h1 className='font-semibold text-xl'>{moment(date).format('DD MMM, YYYY')}</h1>
                       <h1 className='text-lg'>{endDate ? moment(date).format('h:mm A') : time}</h1>
                           
                        </div>
                        <div className='p-5'>
                        <h1 className='text-right text-xl'>{endDate ? moment(endDate, "DD-MM-YYYY").format('DD MMM, YYYY') : moment(date, "DD-MM-YYYY").add('days', 1).format('DD MMM, YYYY') }</h1>
                       <h1 className='text-end text-lg'>{endDate ? moment(endDate).format('h:mm A') : time}</h1>
                        </div>
               ...
               <div className='w-full h-full bg-slate-100 rounded-xl p-4 '>
                  ...
                  <div className='flex mt-2'>
                     ...
                     <div className='rounded-xl  border-2 border-gray-300 mt-5 h-86 w-full p-3 font-semibold'>
                        ...
                        <p className='text-sm text-green-600 underline'>how to does it work</p>
                        ...
                        <div className='flex mt-4 justify-between '>
                            ...
                            <div className='pl-2 md:w-full  w-4/5' >
                                ...
                                <p className='text-sm'>You pay up to INR 3499 in case of any damage</p>
                                <h1 className='text-lg text-green-600'>Most Opted</h1>
                            </div>
                            <div className='w-5 h-5 rounded-full border-black border-2 mt-3  ' value="239" onClick={()=>selectProtection(199)}>
                            { Package === 199  &&  <div className='rounded-full bg-green-600 w-3 h-3 m-0.5'  >
                        ...
                        <div className='flex mt-4 justify-between'>
                            ...
                            <div className='pl-2 md:w-full  w-4/5' >
                                ...
                                <p className='text-sm'>You pay up to INR 999 in case of any damage</p>
                                <h1 className='text-lg text-green-600'>Most Opted</h1>
                            </div>
                            <div className='w-5 h-5 rounded-full border-black border-2 mt-3' value="239" onClick={()=>selectProtection(239)}>
                            { Package === 239  &&  <div className='rounded-full bg-green-600 w-3 h-3 m-0.5'  >
                        ...
                        <div className='flex mt-4 justify-between'>
                            ...
                            <div className='pl-2 md:w-full  w-4/5' >
                                ...
                                <p className='text-sm'>You pay up to INR 99 in case of any damage</p>
                                <h1 className='text-lg text-green-600'>value for money</h1>

                            </div>
                            <div className='w-5 h-5 rounded-full border-black border-2 mt-3' value='309' onClick={()=>selectProtection(309)}>
                            { Package === 309  &&   <div className='rounded-full bg-green-600 w-3 h-3 m-0.5'>
                        ...
                        <div className='flex justify-between -mt-2'>
                            ...
                            <PaySummery  open={Summary} setOpen={setSummary} amount={amount + Package + 99} Package={Package}  />
                        </div>
                        <div className='text-center -mt-2 '>

                        <button className='items-center rounded-lg bg-green-600 text-center w-64 h-12 text-white' onClick={getCheckout}>PROCEED TO PAY ₹{amount + Package + 99}</button>
                        <HostNumberVF />
